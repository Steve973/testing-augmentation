...
Read the [Unit Ledger Generation Procedure](./unit/unit-ledger-spec.md) and generate a ledger for your code unit:
...
Read the [Unit Testing Contract](./unit/unit-testing-contract.md) and generate tests from your ledger:
...
- **[unit-ledger-spec.md](./unit/unit-ledger-spec.md)**
...
- **[unit-testing-contract.md](./unit/unit-testing-contract.md)**
...
- **[unit-ledger-spec_schema.json](./unit/unit-ledger-spec.schema.json)**
...
- **[ledger-generation-prompt.md](./unit/prompt.md)**
...
- **[language-companion-guides/](./unit/language-companion-guides/)**
  ...
  - **[README.md](./unit/language-companion-guides/README.md)**
    - Guide to creating and using companions
  - **[companion-guide-template.md](./unit/language-companion-guides/unit-ledger-language-companion-template.md)**
    - Template for new guides
  - **[python-unit-ledger-companion.md](./unit/language-companion-guides/python-unit-ledger-companion.md)**
    - Python examples (when available)
  - **[java-unit-ledger-companion.md](./unit/language-companion-guides/java-unit-ledger-companion.md)**
...
[companion guide template](./unit/language-companion-guides/unit-ledger-language-companion-template.md).
...
[Unit Ledger Generation Procedure](./unit/unit-ledger-spec.md).